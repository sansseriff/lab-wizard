...
# from lab_wizard.lib.instruments.{{voltage_source_module}} import {{voltage_source_class}}
# from lab_wizard.lib.instruments.{{voltage_sense_module}} import {{voltage_sense_class}}
# from lab_wizard.lib.instruments.{{attenuator_module}} import {{attenuator_class}}
# from lab_wizard.lib.instruments.{{counter_module}} import {{counter_class}}
